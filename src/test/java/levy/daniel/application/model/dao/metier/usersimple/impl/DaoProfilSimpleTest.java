...
/**
 * class DaoProfilSimpleTest :<br/>
 * <ul>
 * <li>Test JUnit de la classe <b>DaoProfilSimple</b>.</li>
...
public class DaoProfilSimpleTest {
	...
	/**
	 * ADMIN : ProfilSimple :<br/>
	 * "ADMINISTRATEUR".<br/>
	 */
	public static final ProfilSimple ADMIN 
		= new ProfilSimple(ProfilsSimplesEnum.ADMINISTRATEUR.toString());

	
	/**
	 * GEST : ProfilSimple :<br/>
	 * "GESTIONNAIRE_DONNEES".<br/>
	 */
	public static final ProfilSimple GEST 
		= new ProfilSimple(ProfilsSimplesEnum.GESTIONNAIRE_DONNEES.toString());
	...
	public static final ProfilSimple UTILISATEUR 
		= new ProfilSimple(ProfilsSimplesEnum.UTILISATEUR.toString());
	 ...
	 */
	@Autowired
	private transient IDaoProfilSimple daoProfilSimple;
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(DaoProfilSimpleTest.class);
	...
	// *************************METHODES************************************/
	 ...
	 /**
	 * method CONSTRUCTEUR DaoProfilSimpleTest() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * <br/>
	 */
	public DaoProfilSimpleTest() {
		super();
	...
	public void testCreateNull() throws AbstractDaoException {
		...
		/* daoProfilSimple NON INJECTE. */
		if (this.daoProfilSimple == null) {
		...
		final ProfilSimple objet1 = null;
		ProfilSimple objet1Persistant = null;
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoProfilSimple.create(objet1);
			/* *********************************************** */
			
			/* Calcul du nombre d'objets en base après le traitement. */
			nombreObjetsFinal = this.daoProfilSimple.count();
	 ...
	 * <ul>
	 * Teste la méthode <b>create(ProfilSimple pObject)</b>.<br/>
	 * <li>garantit que create(ProfilSimple pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testCreate() throws AbstractDaoException {
		...
		ProfilSimple objet1Persistant = null;
		ProfilSimple objet2Persistant = null;
		ProfilSimple objet3Persistant = null;
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoProfilSimple.create(objet1);
			objet2Persistant = this.daoProfilSimple.create(objet2);
			/* *********************************************** */
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet3Persistant = this.daoProfilSimple.create(objet3);
	 ...
	 * <ul>
	 * Teste la méthode <b>create(ProfilSimple pDoublon)</b>.<br/>
	 * <li>garantit que create(ProfilSimple pDoublon) retourne 
	...
	public void testCreateDoublon() 
		...
		ProfilSimple objet1Persistant = null;
		ProfilSimple objet2PersistantEquals1 = null;
		...
		/* Instanciation d'un ProfilSimple. */
		final ProfilSimple objet2Equals1 
		= new ProfilSimple(ProfilsSimplesEnum.GESTIONNAIRE_DONNEES.toString());
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoProfilSimple.create(objet1);
			objet2PersistantEquals1 = this.daoProfilSimple.create(objet2Equals1);
			/* *********************************************** */
	...
	public void testSaveNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoProfilSimple.save(objet1);
			/* *********************************************** */
	 ...
	 * method testSave() :<br/>
	 * <ul>
	 * Teste la méthode <b>save(ProfilSimple pObject)</b>.<br/>
	 * <li>garantit que save(ProfilSimple pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	 ...
	 * <ul>
	 * Teste la méthode <b>save(ProfilSimple pDoublon)</b>.<br/>
	 * <li>garantit que save(ProfilSimple pDoublon) retourne 
	 * null sans lever d'Exception.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testSaveDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			objet1Persistant = this.daoProfilSimple.save(objet1);
			objet2PersistantEquals1 = this.daoProfilSimple.save(objet2Equals1);
			/* *********************************************** */
	...
	public void testPersistNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			this.daoProfilSimple.persist(objet1);
			objet1Persistant = this.daoProfilSimple.retrieve(objet1);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode <b>persist(ProfilSimple pObject)</b>.<br/>
	 * <li>garantit que persist(ProfilSimple pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	 ...
	 * <ul>
	 * Teste la méthode <b>persist(ProfilSimple pDoublon)</b>.<br/>
	 * <li>garantit que persist(ProfilSimple pDoublon) ne fait 
	...
	public void testPersistDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			this.daoProfilSimple.persist(objet1);
			this.daoProfilSimple.persist(objet2Equals1);
			objet1Persistant = this.daoProfilSimple.retrieve(objet1);
			objet2PersistantEquals1 = this.daoProfilSimple.retrieve(objet2Equals1);
			/* *********************************************** */
	...
	public void testPersistSousClasseNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			this.daoProfilSimple.persistSousClasse(objet1);
			objet1Persistant = this.daoProfilSimple.retrieve(objet1);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode 
	 * <b>persistSousClasse(ProfilSimple pObject)</b>.<br/>
	 * <li>garantit que persistSousClasse(ProfilSimple pObject) insère 
	 * un objet en base.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	 ...
	 * <ul>
	 * Teste la méthode 
	 * <b>persistSousClasse(ProfilSimple pDoublon)</b>.<br/>
	 * <li>garantit que persistSousClasse(ProfilSimple pDoublon) 
	...
	public void testPersistSousClasseDoublon() 
		...
		try {
			...
			/* ********************* CREATION **************** */
			this.daoProfilSimple.persistSousClasse(objet1);
			this.daoProfilSimple.persistSousClasse(objet2Equals1);
			objet1Persistant = this.daoProfilSimple.retrieve(objet1);
			objet2PersistantEquals1 = this.daoProfilSimple.retrieve(objet2Equals1);
			/* *********************************************** */
	...
	public void testCreateReturnIdNull() throws AbstractDaoException {
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			idObjetPersistant = this.daoProfilSimple.createReturnId(objet1);
			objet1Persistant = this.daoProfilSimple.findById(idObjetPersistant);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode <b>createReturnId(ProfilSimple pObject)</b>.<br/>
	 * <li>garantit que createReturnId(ProfilSimple pObject) insère 
	 ...
	 * <ul>
	 * Teste la méthode <b>createReturnId(ProfilSimple pDoublon)</b>.<br/>
	 * <li>garantit que createReturnId(ProfilSimple pDoublon) retourne 
	 * null sans lever d'Exception.</li>
	 * </ul>
	 * 
	 * @throws AbstractDaoException 
	...
	public void testCreateReturnIdDoublon() 
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			idObjet1Persistant = this.daoProfilSimple.createReturnId(objet1);
			idObjet2PersistantEquals1 = this.daoProfilSimple.createReturnId(objet2Equals1);
			objet1Persistant = this.daoProfilSimple.findById(idObjet1Persistant);
			objet2PersistantEquals1 = this.daoProfilSimple.findById(idObjet2PersistantEquals1);
			/* *********************************************** */
	...
	public void testSaveLot() 
		...
		List<ProfilSimple> lotPersistant = null;
		
		/* Instanciation de ProfilSimple. */
		final ProfilSimple objet1 
		= new ProfilSimple(ProfilsSimplesEnum.ADMINISTRATEUR.toString());
		
		final ProfilSimple objet2Null = null;
		
		final ProfilSimple objet3Equals1 
		= new ProfilSimple(ProfilsSimplesEnum.ADMINISTRATEUR.toString());
		
		final ProfilSimple objet4 
		= new ProfilSimple(ProfilsSimplesEnum.GESTIONNAIRE_DONNEES.toString());
		
		/* Constitution d'un lot d'objets. */
		final List<ProfilSimple> lot = new ArrayList<ProfilSimple>();
		...
		try {
			...
			/* *********************************************** */
			/* ********************* CREATION **************** */
			lotPersistant = (List<ProfilSimple>) this.daoProfilSimple.save(lot);
			/* *********************************************** */
	 ...
	 * <ul>
	 * Teste la méthode <b>retrieve(ProfilSimple pObject)</b>.<br/>
	 * <li>garantit que retrieve(ProfilSimple pObject) retrouve 
	...
	public void testRetrieve() 
		...
		ProfilSimple objetpersistantInexistant = null;
		...
		final ProfilSimple objet5 
		= new ProfilSimple(ProfilsSimplesEnum.UTILISATEUR.toString());
		
		final ProfilSimple objetInexistant 
		= new ProfilSimple("Pouetr* Pouet");
		...
		/* *********************************************** */
		/* ********************* RETRIEVE **************** */
		objetpersistantInexistant = this.daoProfilSimple.retrieve(objetInexistant);
		...
		/* *********************************************** */
		/* ********************* RETRIEVE **************** */
		objetpersistant = this.daoProfilSimple.retrieve(objet5);
	...
	public void testFindById() 
		...
		/* *********************************************** */
		/* ********************* FINDBYID **************** */
		objetpersistantInexistant = this.daoProfilSimple.findById(100L);
		...
		/* *********************************************** */
		/* ********************* FINDBYID **************** */
		objetpersistant = this.daoProfilSimple.findById(3L);
	...
	public void testFindAll() 
		...
		/* *********************************************** */
		/* ********************* FINDALL ***************** */
		lotPersistant = this.daoProfilSimple.findAll();
	...
	public void testFindAllMax() 
		...
		/* *********************************************** */
		/* ********************* FINDALLMax ************** */
		lotPersistant = this.daoProfilSimple.findAllMax(2L);
	...
	public void testFindAllIterable() 
		...
		List<ProfilSimple> lotPersistant = null;
		Iterable<ProfilSimple> lotPersistantIterable = null;
		...
		/* *********************************************** */
		/* ***************** FINDALL(Ite) **************** */
		lotPersistantIterable = this.daoProfilSimple.findAll(listIds);
		...
		if (lotPersistant != null) {
			...
			final boolean exists1 = this.daoProfilSimple.exists(1L);
			final boolean exists2 = this.daoProfilSimple.exists(2L);
	...
	public void testUpdateInexistant() 
		...
		final ProfilSimple objetInexistant 
		= new ProfilSimple("civiliteInexistant");
		...
		/* ***************** UPDATE(Objet) **************** */
		objetpersistantInexistant 
			= this.daoProfilSimple.update(objetInexistant);
	...
	public void testUpdate() 
		...
		ProfilSimple objet1 = null;
		ProfilSimple objet1Persistant = null;
		ProfilSimple objet1ModifiePersistant = null;
		...
		/* ************** */
		/* Modifications. */
		objet1Persistant.setProfilString("Mr modifié");

		
		/* ************************************************ */
		/* ***************** UPDATE(Objet) **************** */
		objet1ModifiePersistant = this.daoProfilSimple.update(objet1Persistant);
		...
		if (objet1ModifiePersistant != null) {
			...
			assertEquals("Le civilite doit être Mr modifié : "
					, "Mr modifié"
						, objet1ModifiePersistant.getProfilString());
	...
	public void testDeleteInexistant() 
		...
		List<ProfilSimple> lotPersistant = null;
		List<ProfilSimple> lotPersistantApresDelete = null;
		...
		final ProfilSimple objetInexistant 
		= new ProfilSimple("ProfilSimple inexistante");
	
	
		/* remplit de la table. */
		this.remplirTable(affichage);
		this.daoProfilSimple.create(objet1);
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoProfilSimple.delete(objetInexistant);
	
		
		nombreObjetsFinal = this.daoProfilSimple.count();
		
		lotPersistantApresDelete = this.daoProfilSimple.findAll();
	...
	public void testDelete() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoProfilSimple.delete(objet1);
	...
	public void testDeleteByIdInexistant() 
		...
		/* **************************************************** */
		/* ***************** DELETEBYID(Objet) **************** */
		this.daoProfilSimple.deleteById(100L);
	...
	public void testDeleteById() 
		...
		/* ************************************************ */
		/* ***************** DELETEBYID(Objet) **************** */
		this.daoProfilSimple.deleteById(idExistant);
	...
	public void testDeleteByIdBooleanInexistant() 
		...
		resultat = this.daoProfilSimple.deleteByIdBoolean(100L);
	...
	public void testDeleteByIdBoolean() 
		...
		/* ************************************************ */
		/* ***************** DELETE(Objet) **************** */
		resultat = this.daoProfilSimple.deleteByIdBoolean(idExistant);
	...
	private void remplirTable(
		...
		final Long nbeObjetsFinal = this.daoProfilSimple.count();
	...
	private void viderTable() throws AbstractDaoException {
		...
		this.daoProfilSimple.deleteAll();
		
		final Long nbreObjetsFinal = this.daoProfilSimple.count();
	 ...
	 * <b>"DAO NON INSTANCIE - this.daoProfilSimple est NULL"</b>.<br/>
	 * <br/>
	 */
	 ...
	 * <br/>
	 *
	 * @param pObjetPersistant : ProfilSimple : 
	...
	private void afficherObjetPersistant(
			final ProfilSimple pObjetPersistant
	 ...
	 * ProfilSimple pObjetNonPersistant
	 * , Long pNbreObjetsInitial) :<br/>
	 * <ul>
	 * Affiche à la console :
	 ...
	 * <br/>
	 *
	 * @param pObjetNonPersistant : ProfilSimple : 
	 * Objet non persistant en base.<br/>
	 * @param pNbreObjetsInitial : Long : 
	 * Nombre d'objets initialement en base.<br/>
	 */
	private void afficherObjetNonPersistant(
			final ProfilSimple pObjetNonPersistant
				, final Long pNbreObjetsInitial) {
	 ...
	 * Iterable<ProfilSimple> pIterable) :<br/>
	 * fabrique une liste à partir d'un Iterable.<br/>
	 * <br/>
	 *
	 * @param pIterable : Iterable<ProfilSimple>.<br/>
	 * 
	 * @return : List<ProfilSimple>.<br/>
	 */
	public final List<ProfilSimple> fabriquerList(
			final Iterable<ProfilSimple> pIterable) {
		
		final List<ProfilSimple> list = new ArrayList<ProfilSimple>();
		
	    for (final ProfilSimple item : pIterable) {
	        list.add(item);
	    }
...
} // FIN DE LA CLASSE DaoProfilSimpleTest.-----------------------------------
