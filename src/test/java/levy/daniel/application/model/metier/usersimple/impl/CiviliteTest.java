...
public class CiviliteTest {
	 ...
	 * "M.".<br/>
	 */
	public static final String CIVILITE_M = CivilitesEnum.MONSIEUR.getAbreviationEnum();
	 ...
	 * "Mme".<br/>
	 */
	public static final String CIVILITE_MME = CivilitesEnum.MADAME.getAbreviationEnum();
	 ...
	 * "Mlle".<br/>
	 */
	public static final String CIVILITE_MLLE = CivilitesEnum.MADEMOISELLE.getAbreviationEnum();
